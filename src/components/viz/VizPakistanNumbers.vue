    ...
    <v-container inner class="container--inner">
      <v-row justify="center" align="center">  
        <v-col cols="12" md="12">
          ...
          <div class="casestudy-numbers-pakistan mb-md-6 mb-0 text-md-center" >
        ...
        <v-col cols="12" md="10">        
          <div class="pakistan-case-numbers-viz" v-if="!$vuetify.breakpoint.mobile">                            
...
export default {
  ...
  methods: {
    selectData(data) {
      const pakistanButtons = d3.select('.casestudy-numbers-pakistan');
      
      pakistanButtons.selectAll('.v-btn')
        .classed('active-selection', false);

      pakistanButtons.select(`.v-btn.${data}`)
      ...
      d3.selectAll('.pakistan-case-numbers-viz span.dot-pviz').style('background-color', '#C4C4C4');      
      d3.selectAll(`.pakistan-case-numbers-viz ${this.selected}`).style('background-color', '#425D70');
    }
  },
}
</script>
