    <section class='intro'>
     ...
     data-aos-delay='500' >
        ...
        <img  class='introImage' src='https://picsum.photos/200/300' alt='3d illustration of boy with a flag'/>

    </section>

     <section class='guide1'>
       <img class='guide1Image' src='https://picsum.photos/200/300' 
     ...
     <section class='guide2'>
      ...
      data-aos="slide-down"
        ...
        <img class='guide2Image' src='https://picsum.photos/200/300' 
